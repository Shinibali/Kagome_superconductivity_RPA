...
% Function: getH
%###########################################
function [rows,cols,bare_Vnn_fullq] = full_bare_nn_int(qx,qy,nsite,norb,Vnn,bare_int_ind,k_p_or_m_kp)
                ...
                for o1 = 1:norb
                    for is1= 1 : nsite-1
                        for is2 = is1+1 : nsite
                            ...
                            if k_p_or_m_kp == 1 % for -(k+kp), we have -V(1+exp(iq.2a))
                               
                                rw1 = bare_int_ind( o1,is1,o1,is1,isp1,isp1 );
                                cl1 = bare_int_ind( o2,is2,o2,is2,isp2,isp2 );
                                
                                rw2 = bare_int_ind( o2,is2,o2,is2,isp2,isp2 );
                                cl2 = bare_int_ind( o1,is1,o1,is1,isp1,isp1 );
                            ...
                            elseif k_p_or_m_kp == 2 % for -(k-kp), we have V(1+exp(iq.2a))
                                 
                                rw1 = bare_int_ind( o1,is1,o2,is2,isp1,isp2 );
                                cl1 = bare_int_ind( o2,is2,o1,is1,isp2,isp1 );
                                
                                rw2 = bare_int_ind( o2,is2,o1,is1,isp2,isp1 );
                                cl2 = bare_int_ind( o1,is1,o2,is2,isp1,isp2 );
